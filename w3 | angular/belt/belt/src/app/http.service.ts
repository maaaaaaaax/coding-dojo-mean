...
export class HttpService {
  ...
  deletePet(id){
    console.log("we're in service deletePet() now. ID: "+id)
  ...
  addPet(input){
    ...
    console.log(input.name)
    console.log('/new/'+input.name)
    return this._http.post('/pets', input);
  }
  ...
  editPet(input){
    ...
    return this._http.put('/pets/'+input._id, input);
  }

  upvotePet(pet_id){
    return this._http.post('/pets/upvote/'+pet_id);
  }

  // upvotePet(pet_id){
  //   console.log("in http.service.ts upvoteQuote(author_id)", pet_id);
  //   return this._http.post('/pets/upvote/'+pet_id);
  // }
